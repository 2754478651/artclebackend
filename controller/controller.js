...
let controller = {
    ...
    goods_all(req, res) { res.render('goods_all'); },
    goods_cate(req, res) { res.render('goods_cate'); },
    ...
    async getGoods(req, res) {
        ...
        let sql2 = `select * from goods_all`;
    ...
    delGoods(req, res) {
        ...
        let sql = `delete from goods_all where goods_id=${goods_id}`;
    ...
    async add_goods(req, res) {
        ...
        let sql = `insert into goods_all(goods_name,price,depict,category,isShelf,added_time) 
    ...
    async getOneGoods(req, res) {
        ...
        if (!goods_id) return res.json(paramerr);
        let sql = `select * from goods_all where goods_id=${goods_id}`;
    ...
    async edit_goods(req, res) {
        ...
        let sql = `update goods_all set goods_name='${goods_name}',price=${price},depict='${depict}',
